CLASS zcl_renting_load_datajg DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_datajg IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

  DATA: lt_brands TYPE TABLE OF zrent_brandsjg,
        lt_cars TYPE TABLE OF zrent_carsjg,
        lt_customers TYPE TABLE OF zrent_customerjg.
...
( marca = 'BENTLEY' url ='https://www.autobild.es/sites/autobild.es/public/stSAP BTP - ABAP en Cloud Modelo de datos 26 yles/main_element/public/dc/fotos/Bentley-Continental_GT-2018-C01.jpg?itok=_kP_edH4')
...
DELETE FROM zrent_brandsjg.
INSERT zrent_brandsjg FROM TABLE @lt_brands.
SELECT * FROM zrent_brandsjg INTO TABLE @lt_brands.
out->write( sy-dbcnt ).
...
fecha_fabr = '20200418' puertas = '5' precio = '210' moneda = 'USD' alquilado = 'X' alq_desde ='20231201' alq_hasta = '20231231' )
...
fecha_fabr = '20200617' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20230801' alq_hasta = '20230930' )
...
fecha_fabr = '20200304' puertas = '3' precio = '140' moneda = 'USD' alquilado = 'X' alq_desde ='20230701' alq_hasta = '20231008' )
...
fecha_fabr = '20200924' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20230601' alq_hasta = '20231001' )
...
fecha_fabr = '20200726' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20230301' alq_hasta = '20231001' )
...
fecha_fabr = '20200614' puertas = '5' precio = '180' moneda = 'USD' alquilado = 'X' alq_desde = '20231201' alq_hasta = '20231206' )
...
fecha_fabr = '20210716' puertas = '5' precio = '180' moneda = 'USD' alquilado = 'X' alq_desde = '20231201' alq_hasta = '20231106' )
...
fecha_fabr = '20200812' puertas = '3' precio = '150' moneda = 'USD' alquilado = 'X' alq_desde = '20231106' alq_hasta = '20231216' )
).

DELETE FROM zrent_carsjg.
INSERT zrent_carsjg FROM TABLE @lt_cars.
SELECT * FROM zrent_carsjg INTO TABLE @lt_cars.
out->write( sy-dbcnt ).
...
DELETE FROM zrent_customerjg.
INSERT zrent_customerjg FROM TABLE @lt_customers.
SELECT * FROM zrent_customerjg INTO TABLE
@lt_customers.
out->write( sy-dbcnt ).
